...
def _calc_rs_series(stock_close: pd.Series, bench_close: pd.Series, ema_period: int):
    """
    Returns full RS Ratio and RS Momentum pd.Series (not just last value).
    Called by server.py after screen() to pack series into result row for PDF export.
    """
