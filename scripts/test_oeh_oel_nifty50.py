...
print("\n" + "=" * 70)
print("  OEL/OEH OBSERVATION — NIFTY 50 — 2 YEARS HOURLY")
...
for i, (name, ticker) in enumerate(NIFTY50.items(), 1):
    ...
    try:
        ...
        # Build daily for next day / 1 week lookups
        ...
        for date in dates:
            ...
            # Daily index for next day / 1 week
            ...
            # Entry for cutoff 1 = bar 1 Open (10:15)
            ...
            # Entry for cutoff 2 = bar 2 Open (11:15)
            entry_2 = price_1115
...
def show_stats(label, df_list, held_col, direction):
...
print(f"\n\n{'='*70}")
print(f"  RESULTS — CUTOFF 10:15 (1 bar checked)")
print(f"{'='*70}")
show_stats("OEL — Low held until 10:15", all_oel_1bar, "Low_held_full_day", "LONG")
show_stats("OEH — High held until 10:15", all_oeh_1bar, "High_held_full_day", "SHORT")

print(f"\n\n{'='*70}")
print(f"  RESULTS — CUTOFF 11:15 (2 bars checked)")
print(f"{'='*70}")
show_stats("OEL — Low held until 11:15", all_oel_2bar, "Low_held_full_day", "LONG")
show_stats("OEH — High held until 11:15", all_oeh_2bar, "High_held_full_day", "SHORT")
